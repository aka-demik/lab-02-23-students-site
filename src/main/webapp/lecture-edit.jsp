...
<%--@elvariable id="lecture" type="services.SuperUserService.Lecture"--%>
<%--@elvariable id="lectures" type="java.util.Collection<models.pojo.CallReason>"--%>
<html>
<head>
                ...
                <div class="form-group">
                    <label>
                        ...
                        <input type="datetime-local" class="form-control" name="time"
                               value="<%=new SimpleDateFormat("yyyy-MM-dd'T'hh:mm").format(lecture.schedule.scheduledAt)%>">
                    </label>
                </div>
                <div class="form-group">
