...
import com.aka.dao.exceptions.CallDAOException;
...
public class LectureDAOImpl extends AbstractDAO<Lecture> implements LectureDAO {
    private static Logger logger = Logger.getLogger(LectureDAOImpl.class);
    ...
    @Override
    protected void prepareInsert(Lecture obj, PreparedStatement statement) throws CallDAOException {
        try {
    ...
    @Override
    protected void prepareUpdate(Lecture obj, PreparedStatement statement) throws CallDAOException {
        try {
    ...
    @Override
    protected Lecture createObj() {
        return new Lecture();
    }

    @Override
    protected Lecture readObj(Lecture obj, ResultSet source) throws CallDAOException {
        try {
